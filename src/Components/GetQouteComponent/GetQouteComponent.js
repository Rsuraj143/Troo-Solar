  ...
  return (
   ...
   <div className="row">
      ...
      <div className="col-md-5">
           ...
           <div className="get-socail">
              <div className="socail-tile">Follow Me on Social Media</div>
              <ul>
            ...
            <form className="row g-3">
              ...
              <div className="col-md-6">
                <div className="field">
                    ...
                    <input type="CompanyName" className="form-control" id="inputCompanyName" placeholder="Company Name"/>
                 </div>
              </div>
              
              <div className="col-md-6">
                <div className="field">
                <label for="inputYourEmail" className="form-label">Email Address</label>
                <input type="text" className="form-control" id="inputYourEmail" placeholder="Email Address"/>
              </div>
              </div>
              <div className="col-md-6">
                <div className="field">
              ...
              <div className="col-md-6">
                <div className="field">
                <label for="inputSubject" className="form-label">What Services Are You Interested In?</label>
              ...
              <div className="col-md-6">
                <div className="field">
                <label for="inputSubject" className="form-label">Rate Your Urgency <small>(0 not urgent / 10 emergency)</small></label>
                <select id="inputSubject" className="form-select">
              ...
              <div className="col-md-12">
               ...
               <div className="col-12">
                <button type="submit" className="read-cta green-btn">Send Message <img src={arrow} alt='arrow' /></button>
              </div>
            </form>
          </div>
        </div>
